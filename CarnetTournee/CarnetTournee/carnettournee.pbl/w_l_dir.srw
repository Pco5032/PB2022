//objectcomments Sélection propriété (PROP), possibilité de restreindre aux
forward
global type w_l_dir from w_ancestor
end type
type cb_cancel from uo_cb_cancel within w_l_dir
end type
type cb_ok from uo_cb_ok within w_l_dir
end type
type dw_1 from uo_ancestor_dwbrowse within w_l_dir
end type
end forward
...
integer width = 1189
integer height = 1740
string title = "Sélection d~'une direction"
...
IF dw_1.uf_extendedselect() THEN
	...
	DO WHILE ll_selrow > 0
		li_param++
		lstr_params.a_param[li_param] = dw_1.Object.d[ll_selrow]
