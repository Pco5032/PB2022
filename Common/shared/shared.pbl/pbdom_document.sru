...
public function  boolean          SetXMLDeclaration (string version, string encoding, string standalone)
public function  boolean          GetXMLDeclaration (ref string version, ref string encoding, ref string standalone)
end type
