//objectcomments Sélection catalogue
forward
global type w_l_catalogue from w_ancestor
end type
type cb_cancel from uo_cb_cancel within w_l_catalogue
end type
type cb_ok from uo_cb_ok within w_l_catalogue
end type
type dw_1 from uo_ancestor_dwbrowse within w_l_catalogue
end type
end forward
...
integer width = 1102
integer height = 1716
string title = "Sélection d~'un catalogue"
...
global w_l_catalogue w_l_catalogue
...
IF dw_1.uf_extendedselect() THEN
	...
	DO WHILE ll_selrow > 0
		li_param++
		lstr_params.a_param[li_param] = dw_1.Object.num_cat[ll_selrow]
...
integer taborder = 10
string title = ""
string dataobject = "d_l_catalogue"
