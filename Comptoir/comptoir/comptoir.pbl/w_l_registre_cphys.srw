//objectcomments Sélection caractéristiques physiques du lot (voir document fournisseur)
forward
global type w_l_registre_cphys from w_ancestor
end type
type cb_ok from uo_cb_ok within w_l_registre_cphys
end type
type cb_cancel from uo_cb_cancel within w_l_registre_cphys
end type
type dw_1 from uo_ancestor_dwbrowse within w_l_registre_cphys
end type
end forward
...
integer width = 2784
integer height = 2084
string title = "Sélection des caractéristiques physiques des graines"
...
global w_l_registre_cphys w_l_registre_cphys

type variables

end variables

on w_l_registre_cphys.create
int iCurrent
call super::create
...
IF ll_selrow > 0 THEN
	lstr_params.a_param[1] = dw_1.Object.num_cphys[ll_selrow]
...
string dataobject = "d_l_registre_cphys"
